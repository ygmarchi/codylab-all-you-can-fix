package it.intesys.shippingservice.api.problem;

import it.intesys.shippingservice.exception.ShippingServiceException;
...
public class ApiErrorHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleOrderServiceException(ShippingServiceException ex, WebRequest request) {
        return handleOrderServiceException(ex, HttpStatus.INTERNAL_SERVER_ERROR, request);
    }

    private ResponseEntity<Object> handleOrderServiceException(ShippingServiceException ex, HttpStatus status, WebRequest request) {
